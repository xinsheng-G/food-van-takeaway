...
let vanSchema = new Schema({
     ...
     *
     * However, If we use these arrays for storing orders , if we want to get these order details,we have to travel all the order id
     ...
     * order and its details, just call `orders.find(van_name)` method for once, then this method will travel the database for only one time
